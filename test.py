...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt',type=str,default='/mnt/sdb/zbl/FlareDataSet2/test/real/gt')
    parser.add_argument('--mask',type=str,default='/mnt/sdb/zbl/FlareDataSet2/test/real/mask')
    getResult()
